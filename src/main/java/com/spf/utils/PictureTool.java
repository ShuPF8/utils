...
public class PictureTool {
    ...
    protected static Logger logger = LogManager.getLogger(PictureTool.class);

    public static void main(String[] args) throws Exception {
        String firstPic = "D:\\Backup\\Desktop\\gx\\lg\\1\\14.png";
        String secondPic = "D:\\Backup\\Desktop\\gx\\lg\\1\\1.png";
        String path = "D:/Backup/Desktop/gx/lg/pic1/";
        xPic(firstPic,secondPic,"1",path);
    }
    ...
    public final static String PATH = "D:/Backup/Desktop/";

    /**
     * 横向合成图片
     * @param firstPic 第一张图片
     * @param secondPic 第二张图片
     * @param name 合成后的图片名
     * @param path 保存路径
     */
    public static void xPic(String firstPic, String secondPic, String name, String path) {
        try {
            /* 1 读取第一张图片 */
     ...
     * @param border 图片预留边框
     */
    public static boolean yPic(String firstPic, String secondPic, String name, String path, int border) {
        boolean isOk = true;
        try {
            /* 1 读取第一张图片 */
...
//            height = imageFirst.getHeight();// 图片高度
     ...
     */
    public static void saveImage(String name, String path, byte[] bytes) throws Exception {
        ...
        try {
            ...
            os = new FileOutputStream(path + name.toLowerCase() + ".png");
            os.write(bytes);
        } catch (Exception e) {
     ...
     * @throws IOException 异常
     */
    public static void saveImage(String name, byte[] bytes) throws Exception {
        saveImage(name, null, bytes);
    }
     ...
     * @return
     */
    public static byte[] cropToByte(BufferedImage source, int startX, int startY, int endX, int endY) throws IOException {
        BufferedImage image = crop(source,startX,startY,endX,endY);
        ByteArrayOutputStream out = new ByteArrayOutputStream();
