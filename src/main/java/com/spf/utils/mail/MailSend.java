...
public class MailSend {
        ...
        public static String myEmailAccount = "1215852831@qq.com";
        public static String myEmailPassword = "oeqpexrdfrlniead";

        // 发件人邮箱的 SMTP 服务器地址, 必须准确, 不同邮件服务器地址不同, 一般(只是一般, 绝非绝对)格式为: smtp.xxx.com
        // 网易163邮箱的 SMTP 服务器地址为: smtp.163.com
        public static String WYEmailSMTPHost = "smtp.163.com";

        public static String qqEmailSMTPHost = "smtp.qq.com";
        ...
        private static Session init() {
            ...
            props.setProperty("mail.smtp.host", qqEmailSMTPHost);   // 发件人的邮箱的 SMTP 服务器地址
